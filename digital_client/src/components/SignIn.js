      ...
      <div className="row h-100 align-items-center justify-content-center" style={{ minHeight: '100vh' }}>
        <div className="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-6">
          <div className="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
            ...
            <p className="text-center mb-0">Become a <a href="/ProviderSignup">Service Provider</a>!</p><br />
            <p className="text-center mb-0">Do you have Products to sell, Register as an <a href="/EntrepreneurSignup">Entrepreneur</a>!</p>
          </div>
        </div>
      </div>
    </div>
